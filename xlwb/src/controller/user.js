...
const {
    registerUserNameNotExistInfo, registerUserNameExistInfo, registerFailInfo, loginFailInfo, changeInfoFailInfo, changePasswordFailInfo,
...
async function register({
    ...
    try {
        await createUser({
            userName, password: doCrypto(password), nickName: nickName || userName, gender,
        })
...
async function login({ ctx, userName, password }) {
    try {
        ...
        return new SuccesModel(userInfo.dataValues)
    } catch (error) {
        console.log(error)
...
async function changeInfo({
    ...
    if (res) {
        ...
        ctx.session.userInfo = {
            ...userInfo, nickName, picture, city,
        }
        return new SuccesModel()
    }
